...
@component('form::form._form_group',['field' => 'document_number'])
    {{ Form::label('document_number', 'Document',['class' => 'control-label']) }}
...
{{--            <input type="radio" name="sex" value="f" {{ old('sex', $sex) == 'f'?'checked="checked"' : ''}}> Female--}}
    ...
    @component('form::form._form_group',['field' => 'physical_disability'])
        {{ Form::label('physical_disability', 'Physical Disability',['class' => 'control-label']) }}
...
<div class="checkbox">
    <label>
        {{ Form::checkbox('defaulter') }} Defaulting?
